...
class DailySheetInventoryListSerializer(serializers.Serializer):
    ...
    def to_representation(self, instance):
        ...
        print(data)
        data = {'operational_products': {'id':2, 'name':"operational_products", 'completed_status':InventoryControl.objects.filter(branch__pk=branch, date__date=date, product__classification__code=2).exists()},
