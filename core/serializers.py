...
class DailySheetInventoryListSerializer(serializers.Serializer):
    ...
    def to_representation(self, instance):
        ...
        inventory_data =  {
                    ...
                    'vegetable_products':{'id':4, 'name':"vegetable_products", 'completed_status':InventoryControl.objects.filter(branch__pk=branch, date__date=date, status=True, delete=False, product__classification__code=4).exists()},
